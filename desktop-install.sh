...
sudo pacman -S alsa-utils alsa-firmware pulseaudio pulseaudio-alsa pulseaudio-equalizer pulseaudio-jack vlc mplayer rhytmbox audiocd-kio libcdio lidvdread libdvdcss libdvdnav --noconfirm --needed 
