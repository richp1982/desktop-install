...
sudo pacman -S ibus okular gparted xf86-input-synaptics ffmpegthumbs nemo ttf-dejavu ttf-liberation dmenu nitrogen picom lxappearance archlinux-wallparper --noconfirm --needed
