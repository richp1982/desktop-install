...
sudo pacman -S ibus okular gparted xf86-input-synaptics ffmpegthumbs nemo ttf-dejavu ttf-liberation feh picom lxappearance archlinux-wallpaper --noconfirm --needed
...
chmod +x launch.sh
cp launch.sh /home/rich/.config/polybar/
